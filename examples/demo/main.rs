...
fn main()
{
    ...
    let a = Buffer::<isize>::new(&ctx, &vec_a[..], opencl::cl::CL_MEM_READ_ONLY);
    let b = Buffer::<isize>::new(&ctx, &vec_b[..], opencl::cl::CL_MEM_READ_ONLY);
    let c = Buffer::<isize>::new_uninitialized(&ctx, 8, opencl::cl::CL_MEM_WRITE_ONLY);
