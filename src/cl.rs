...
pub const CL_BUILD_NONE:                                cl_uint = (-1isize) as cl_uint;
pub const CL_BUILD_ERROR:                               cl_uint = -2isize as cl_uint;
pub const CL_BUILD_IN_PROGRESS:                         cl_uint = -3isize as cl_uint;
