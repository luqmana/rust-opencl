...
fn main()
{
  unsafe
  {
    ...
    clGetPlatformIDs(1, ptr::to_unsafe_ptr(&p_id), ptr::to_unsafe_ptr(&np));
    r = clGetDeviceIDs(p_id, CL_DEVICE_TYPE_CPU, 1, ptr::to_unsafe_ptr(&device), ptr::to_unsafe_ptr(&nd));
