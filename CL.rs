...
pub enum CLStatus {
    pub CL_SUCCESS = 0,
    pub CL_DEVICE_NOT_FOUND = -1,
    pub CL_DEVICE_NOT_AVAILABLE = -2,
    pub CL_COMPILER_NOT_AVAILABLE = -3,
    pub CL_MEM_OBJECT_ALLOCATION_FAILURE = -4,
    pub CL_OUT_OF_RESOURCES = -5,
    pub CL_OUT_OF_HOST_MEMORY = -6,
    pub CL_PROFILING_INFO_NOT_AVAILABLE = -7,
    pub CL_MEM_COPY_OVERLAP = -8,
    pub CL_IMAGE_FORMAT_MISMATCH = -9,
    pub CL_IMAGE_FORMAT_NOT_SUPPORTED = -10,
    pub CL_BUILD_PROGRAM_FAILURE = -11,
    pub CL_MAP_FAILURE = -12,
    pub CL_MISALIGNED_SUB_BUFFER_OFFSET = -13,
    pub CL_EXEC_STATUS_ERROR_FOR_EVENTS_IN_WAIT_LIST = -14,
    pub CL_INVALID_VALUE = -30,
    pub CL_INVALID_DEVICE_TYPE = -31,
    pub CL_INVALID_PLATFORM = -32,
    pub CL_INVALID_DEVICE = -33,
    pub CL_INVALID_CONTEXT = -34,
    pub CL_INVALID_QUEUE_PROPERTIES = -35,
    pub CL_INVALID_COMMAND_QUEUE = -36,
    pub CL_INVALID_HOST_PTR = -37,
    pub CL_INVALID_MEM_OBJECT = -38,
    pub CL_INVALID_IMAGE_FORMAT_DESCRIPTOR = -39,
    pub CL_INVALID_IMAGE_SIZE = -40,
    pub CL_INVALID_SAMPLER = -41,
    pub CL_INVALID_BINARY = -42,
    pub CL_INVALID_BUILD_OPTIONS = -43,
    pub CL_INVALID_PROGRAM = -44,
    pub CL_INVALID_PROGRAM_EXECUTABLE = -45,
    pub CL_INVALID_KERNEL_NAME = -46,
    pub CL_INVALID_KERNEL_DEFINITION = -47,
    pub CL_INVALID_KERNEL = -48,
    pub CL_INVALID_ARG_INDEX = -49,
    pub CL_INVALID_ARG_VALUE = -50,
    pub CL_INVALID_ARG_SIZE = -51,
    pub CL_INVALID_KERNEL_ARGS = -52,
    pub CL_INVALID_WORK_DIMENSION = -53,
    pub CL_INVALID_WORK_GROUP_SIZE = -54,
    pub CL_INVALID_WORK_ITEM_SIZE = -55,
    pub CL_INVALID_GLOBAL_OFFSET = -56,
    pub CL_INVALID_EVENT_WAIT_LIST = -57,
    pub CL_INVALID_EVENT = -58,
    pub CL_INVALID_OPERATION = -59,
    pub CL_INVALID_GL_OBJECT = -60,
    pub CL_INVALID_BUFFER_SIZE = -61,
    pub CL_INVALID_MIP_LEVEL = -62,
    pub CL_INVALID_GLOBAL_WORK_SIZE = -63,
    pub CL_INVALID_PROPERTY = -64,
}
...
pub mod ll {
  ...
  extern
  {
    ...
    pub fn clCreateContextFromType(properties: *cl_context_properties,
                               device_type: cl_device_type,
                               pfn_notify: extern fn (*libc::c_char, *libc::c_void, libc::size_t, *libc::c_void),
                               user_data: *libc::c_void,
                               errcode_ret: *cl_int) -> cl_context;
